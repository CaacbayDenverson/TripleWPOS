...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3942943309ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=triplew&table=invoice">`triplew`.`invoice`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=testing4&table=tbl_order">`testing4`.`tbl_order`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=testing4&table=tbl_order_item">`testing4`.`tbl_order_item`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=simpleinvoicephp&table=invoice_order">`simpleinvoicephp`.`invoice_order`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=simpleinvoicephp&table=invoice_user">`simpleinvoicephp`.`invoice_user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=triplew&table=account">`triplew`.`account`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=simpleinvoicephp&table=invoice_order_item">`simpleinvoicephp`.`invoice_order_item`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=triplew&table=product">`triplew`.`product`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=maiskorn&table=users">`maiskorn`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=triplew&table=category">`triplew`.`category`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="5c51634a5f517064462927772a7c5e3c">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="triplew" targettable="invoice">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `invoice`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="simpleinvoicephp" targettable="invoice_user">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `invoice_user`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="simpleinvoicephp" targettable="invoice_order">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `invoice_order`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="testing4" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
...
ALTER TABLE `tbl_order_item`
  MODIFY `order_item_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="testing4" targettable="tbl_order">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbl_order`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="testing4" targettable="tbl_order">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbl_order`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="testing4" targettable="tbl_order_item">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbl_order_item`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="testing4" targettable="tbl_order_item">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `invoice` DROP `invoice_id`;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="triplew" targettable="invoice">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `invoice`  ADD `order_id` INT NOT NULL  FIRST,  ADD `order_no` INT NOT NULL  AFTER `order_id`,  ADD   PRIMARY KEY  (`order_id`);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="triplew" targettable="invoice">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `invoice`  ADD `order_id` INT(11) NOT NULL  FIRST,  ADD `order_no` INT(11) NOT NULL  AFTER `order_id`,  ADD   PRIMARY KEY  (`order_id`);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="triplew" targettable="invoice">
                            <div class="action_content">
