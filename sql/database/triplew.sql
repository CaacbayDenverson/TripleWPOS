...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2533471910ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=triplew&table=invoice">`triplew`.`invoice`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=triplew&table=product">`triplew`.`product`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=maiskorn&table=users">`maiskorn`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=triplew&table=account">`triplew`.`account`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=triplew&table=category">`triplew`.`category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fast_food_system_db&table=category">`fast_food_system_db`.`category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fast_food_system_db&table=users">`fast_food_system_db`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fast_food_system_db&table=sales">`fast_food_system_db`.`sales`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fast_food_system_db&table=admin">`fast_food_system_db`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fast_food_system_db&table=itemlist">`fast_food_system_db`.`itemlist`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="fast_food_system_db" targettable="category">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `category`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="fast_food_system_db" targettable="admin">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT `password` FROM `admin` WHERE `admin`.`id` = 1</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="fast_food_system_db" targettable="admin">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            targetdb="fast_food_system_db" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">DROP TABLE `admin`, `category`, `itemlist`, `users`;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="fast_food_system_db" targettable="">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">/*!40101 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNECTION */;</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="fast_food_system_db" targettable="sales">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `sales`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="fast_food_system_db" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `category`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="triplew" targettable="category">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `triplew`.`category` ( `id` INT(11) NOT NULL AUTO_INCREMENT ,  `category` VARCHAR(100) NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="triplew" targettable="product">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `product`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="triplew" targettable="account">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
...
(7, &#039;admin&#039;, &#039;Amir El Amari&#039;, &#039;2187th Narra Lane Old Cabalan Olongapo City&#039;, &#039;09454123288&#039;, &#039;$2y$10$B5aSagPaEulNL2E2Hz8EveEwThlsB.OU039Q7RicvIVxVhofyZ4NK&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="triplew" targettable="account">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `invoice`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="maiskorn" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">DROP TABLE `account`, `category`, `invoice`, `product`;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="triplew" targettable="">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `invoice` DROP `acc_id`;</span>
                        </div>
