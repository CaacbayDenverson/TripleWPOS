...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1238243192ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=triplew&table=product">`triplew`.`product`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sales&table=products">`sales`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=triplew&table=invoice">`triplew`.`invoice`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=triplew&table=account">`triplew`.`account`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=maiskorn&table=products">`maiskorn`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=maiskorn&table=users">`maiskorn`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ite316&table=tasks">`ite316`.`tasks`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ite316&table=customer">`ite316`.`customer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ite316&table=user_tbl">`ite316`.`user_tbl`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
            ...
            Queried time
                            ...
                            targetdb="ite316" targettable="tasks">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `account`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="ite316" targettable="user_tbl">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tasks`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="ite316" targettable="customer">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="maiskorn" targettable="products">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">DROP TABLE `account`, `product`;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="triplew" targettable="">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">/*!40101 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNECTION */;</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="sales" targettable="products">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `products` (`product_id`, `product_code`, `gen_name`, `product_name`, `cost`, `o_price`, `price`, `profit`, `supplier`, `onhand_qty`, `qty`, `qty_sold`, `expiry_date`, `date_arrival`) VALUES (&#039;1&#039;, &#039;121212&#039;, &#039;sample&#039;, &#039;sample&#039;, &#039;100&#039;, &#039;100&#039;, &#039;100&#039;, &#039;200&#039;, &#039;Unknown&#039;, &#039;100&#039;, &#039;100&#039;, &#039;50&#039;, &#039;&#039;, &#039;&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sales" targettable="products">
                            <div class="action_content">
